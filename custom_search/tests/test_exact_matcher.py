...
@pytest.mark.parametrize(["name", "terms", "does_match"],
    matches_testcases.values(),
    ids=matches_testcases.keys())
...
@pytest.mark.parametrize(["name", "terms", "does_match"],
    matches_case_insensitive_testcases.values(),
    ids=matches_case_insensitive_testcases.keys())
...
indexesOf_case_insensitive_testcases = {
    "Full string match":                ("Test", ["Test"], [(0,4)]),
...
@pytest.mark.parametrize(["name", "terms", "expected_indicies"],
    indexesOf_case_insensitive_testcases.values(),
    ids=indexesOf_case_insensitive_testcases.keys())
