...
@pytest.mark.parametrize(["name", "terms", "does_match"], exact_matcher_matches_testcases.values(), ids=exact_matcher_matches_testcases.keys())
...
@pytest.mark.parametrize(["name", "terms", "expected_indicies"], exact_matcher_indexesOf_testcases.values(), ids=exact_matcher_indexesOf_testcases.keys())
...
@pytest.mark.parametrize(["name", "terms", "does_match"], exact_matcher_case_insensitive_matches_testcases.values(), ids=exact_matcher_case_insensitive_matches_testcases.keys())
...
@pytest.mark.parametrize(["name", "terms", "expected_indicies"], exact_matcher_case_insensitive_indexesOf_testcases.values(), ids=exact_matcher_case_insensitive_indexesOf_testcases.keys())
